...
- If no model is specified, use the latest Claude Opus model, unless you are a Claude model yourself in which case you should use the latest GPT Sol model.
